...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // withCredentials: true sends the HttpOnly cookie back and forth
  ...
  return (
    <>
      <style>{`
        ...
        @keyframes sparkleMove { 0%, 100% { transform: translateY(0) rotate(0deg); } 50% { transform: translateY(-20px) rotate(180deg); } }
        ...
        .login-left h1 { font-size: 42px; font-style: italic; animation: fadeInUp 1.2s ease-out; }
        .login-left p { margin-top: 20px; font-size: 18px; max-width: 380px; animation: float 6s ease-in-out infinite; font-style: italic; }
        .glow-circle { position: absolute; width: 150px; height: 150px; border-radius: 50%; background: radial-gradient(circle at 30% 30%, rgba(255,255,255,0.15), transparent 70%); filter: blur(70px); animation: glowPulse 6s ease-in-out infinite; }
        .orb { position: absolute; width: 120px; height: 120px; top: 15%; left: 10%; border-radius: 50%; background: radial-gradient(circle, rgba(255,255,255,0.6), transparent); animation: rotateOrb 12s linear infinite; }
        .light-ray { position: absolute; width: 600px; height: 2px; background: linear-gradient(90deg, transparent, rgba(255,255,255,0.4), transparent); animation: lightRays 8s ease-in-out infinite; }
        .ray1 { top: 30%; } .ray2 { top: 70%; animation-delay: 3s; }
        .sparkle { position: absolute; width: 8px; height: 8px; background: rgba(255,255,255,0.9); border-radius: 50%; animation: sparkleMove 6s ease-in-out infinite; }
        .s1 { top:10%; left:15%; } .s2 { top:30%; left:60%; animation-delay:1s } .s3 { top:70%; left:25%; animation-delay:2s } .s4 { top:85%; left:80%; animation-delay:3s } .s5 { top:50%; left:40%; animation-delay:4s } .s6 { top:20%; left:80%; animation-delay:5s }
        .login-right { flex: 1; display: flex; justify-content: center; align-items: center; margin-left: -8%; }
        .login-form { background: rgba(255,255,255,0.95); width: 380px; padding: 50px 45px; border-radius: 18px; text-align: center; animation: fadeInUp 1s ease-out; }
        .login-form h2 { font-size: 20px; color: #6a1b9a; margin-bottom: 25px; font-style: italic; font-weight: 700; }
        .login-form label { display: block; text-align: left; font-size: 14px; color: #4a148c; margin-bottom: 6px; }
